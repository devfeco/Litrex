...
extension WidgetExtension on Widget? {
  ...
  Widget onTap(
    ...
    return InkWell(
      ...
      borderRadius: borderRadius ?? (defaultInkWellRadius != null ? radiusWidget(defaultInkWellRadius) : null),
      child: this,
...
Widget snapWidgetHelper<T>(
  ...
  if (snap.hasError) {
    ...
    return Observer(builder: (_) {
      return wishListStore.isNetworkAvailable
          ? Text(
        defaultErrorMessage ?? errorSomethingWentWrong.toString(),
